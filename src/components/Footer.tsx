      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 mb-5">
              ...
              <span className="text-2xl font-display font-bold">Wanderlust</span>
            </Link>
            <p className="text-primary-foreground/70 mb-6 leading-relaxed">
              Crafting unforgettable African adventures since 2015. Let us be
              your guide to the continent's most breathtaking destinations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:hello@wanderlust.co.ke"
                  className="text-primary-foreground/70 hover:text-primary transition-colors"
                >
                  hello@wanderlust.co.ke
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-primary-foreground/50 text-sm">
            © 2025 Wanderlust Tours. All rights reserved.
          </p>
