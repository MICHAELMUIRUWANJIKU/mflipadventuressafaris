...
const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="Beautiful tropical beach destination" className="w-full h-full object-cover" />
      ...
      <div className="relative container mx-auto px-4 pt-24 pb-16">
        <div className="max-w-3xl">
          ...
          delay: 0.2
            ...
            <span className="text-sm text-primary-foreground/90">Discover Hidden Gems in Kenya and BEyond</span>
          </motion.div>
          ...
          duration: 0.6,
          delay: 0.4
        }} className="text-lg md:text-xl text-primary-foreground/80 mb-8 max-w-xl">Experience breathtaking safaris, Dream beaches sunsets, Strong teams and unforgettable Trips. Let us craft your perfect adventure.</motion.p>
