  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 overflow-hidden">
        ...
        {/* Featured Badge */}
        {featured && (
          <div className="absolute top-4 left-4 px-3 py-1 rounded-full bg-gradient-sunset text-primary-foreground text-xs font-semibold">
            Featured
          </div>
        )}
        ...
        <button
          ...
          className="absolute top-4 right-4 w-9 h-9 rounded-full glass flex items-center justify-center transition-transform hover:scale-110"
        >
          <Heart
